...
실제 배포된 AWS 아키텍처입니다. 자세한 컴포넌트별 값(EC2/RDS 리전, CloudFront behavior 등)과 CI/CD 파이프라인은 [10-infrastructure-architecture.md](docs/choiswgg/10-infrastructure-architecture.md) 참고.
