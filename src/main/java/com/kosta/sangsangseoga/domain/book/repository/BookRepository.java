...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    Page<Book> findBooks(@Param("bookType") BookType bookType,
    ...
    Page<Book> findBooksByPopular(@Param("bookType") BookType bookType,
                                  @Param("keyword") String keyword,
                                  Pageable pageable);
    ...
    List<Book> findRecommendations(@Param("bookType") BookType bookType,
